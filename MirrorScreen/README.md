...
基于 DXGI Desktop Duplication API 的高性能屏幕捕获 DLL 库使用指南。
...
| DLL | 版本 | 功能 | 推荐使用 |
|-----|------|------|---------|
| DxgiGrab3.dll | v3.0 | 完整功能（推荐） | ✅ |
| DxgiGrab2.dll | v2.0 | 脏矩形功能 | - |
| DxgiGrab.dll | v1.0 | 基础捕获 | - |
